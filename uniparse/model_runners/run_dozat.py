"""Run script for dozat and manning."""
...
from uniparse.models.dynet.dozat import Dozat
...
if __name__ == "__main__":
    ...
    # prep params
    parser = Model(
        model, decoder="eisner", loss="crossentropy", optimizer="adam", vocab=vocab
    )

    parser.train(
        train_batches, arguments.dev, dev_batches, epochs=n_epochs, callbacks=callbacks
    )
